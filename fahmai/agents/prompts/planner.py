...
PLANNER_SYS = (
    ...
    "- Supply/operational cause mentioned in internal LINE WORKS chats (e.g. which branch closed, "
    "which vendor had shortage, what event caused sales drop) → 'sql' via document_evidence "
    "chunk_text ILIKE '%keyword%' (e.g. '%BKK-PKT%', '%V-005%', '%Songkran%'). These entity "
    "names are findable by keyword without semantic search.\n"

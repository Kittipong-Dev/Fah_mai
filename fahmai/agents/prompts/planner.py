...
PLANNER_SYS = (
    ...
    "vendor_invoice_id HAVING COUNT(*)>1 — the duplicate invoice IS in the SQL table; do NOT "
    "route this to rag. LINE WORKS / LINE OA are context framing; the actual invoice ID, amounts, "
    "and dates are all in SQL tables. "

...
PLANNER_SYS = (
    ...
    "- Document / chat / email / memo / minutes content — including COUNTING threads or documents — "
    "is handled ONLY by 'rag' (the rag_chunks store). The 'sql' agent must NOT be asked to query "
    "documents or rag_chunks; it answers only from the structured warehouse surfaces.\n"

...
def main(
    ...
    print(f"running {len(selected)} current-enterprise eval questions (concurrency={CONCURRENCY})...\n")
...
if __name__ == "__main__":
    ...
    args = p.parse_args()
    raise SystemExit(main(ids=args.ids, limit=args.limit, all_questions=args.all_questions, out=args.out))
